export interface UsStatePath {
  id: string; // 2-letter uppercase postal code (e.g. "CA", "TX")
  name: string; // Full state name
  path: string; // SVG path data (d)
}

/**
 * Standard Albers USA Composite Projection SVG Map Data
 * Source: Official Wikimedia Standard US States Map (viewBox: "0 0 959 593")
 * Includes all 50 states plus the District of Columbia.
 */
export const US_STATES_MAP_DATA: UsStatePath[] = [
  {
    "id": "AK",
    "name": "Alaska",
